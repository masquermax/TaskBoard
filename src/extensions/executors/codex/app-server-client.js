...
export class CodexAppServerClient {
  ...
  async runTurn({ cwd, writableRoots = [], prompt, inputItems = [], outputSchema, model = null, reasoningEffort = null, networkAccess = false, permissionProfile = null, runtimeWorkspaceRoots = [], environments = null, runtimeConfig = null, onProgress = null, onExecutionStarted = null, signal = null, diagnosticContext = null, stopCondition = null }) {
    ...
    if(!this.sameRuntimeRoots(executionGrant.roots,thread?.runtimeWorkspaceRoots||[])){
      this.recordDiagnostic('runtime-roots-mismatch',{
        ...routeMeta,
        requestedPermissionProfile:executionGrant.profile,
        activePermissionProfile,
        requestedRuntimeWorkspaceRoots:executionGrant.roots,
        returnedRuntimeWorkspaceRoots:thread?.runtimeWorkspaceRoots??null,
        cwd,
