...
export class CodexAppServerClient{
  ...
  emitNotification(msg){this.recentNotifications.push(msg);if(this.recentNotifications.length>200)this.recentNotifications.shift();for(const waiter of [...this.notificationWaiters])if(waiter.predicate(msg)){this.notificationWaiters.splice(this.notificationWaiters.indexOf(waiter),1);waiter.resolve(msg);}}
