...
/**
 * Observability records execution facts only. It deliberately does not infer
 * semantic operation classes from command text; Root/Validator truth must never
...
export const WorkUnitObservabilityInternals={registryKey};
