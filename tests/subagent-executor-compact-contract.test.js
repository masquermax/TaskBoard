...
test('Codex Subagent contract is compact and contains no Task-level next-work discovery surface',()=>{
  ...
  assert.equal('discoveries' in subagentSchema.properties,false);
  assert.equal(subagentSchema.required.includes('discoveries'),false);
